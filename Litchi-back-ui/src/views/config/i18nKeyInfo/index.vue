<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="i18nKeyInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="位置" align="center" prop="keyAddress" width="100" v-if="columns[2].visible">
        <template #default="scope">
          <image-preview :src="scope.row.keyAddress" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="i18nKeyInfoRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="位置" prop="keyAddress">
          <image-upload v-model="form.keyAddress" :limit="1"/>
        </el-form-item>
