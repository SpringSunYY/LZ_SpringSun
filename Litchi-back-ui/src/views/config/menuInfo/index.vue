<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="显示位置" align="center" prop="menuAddress">
        <template #default="scope">
          <dict-tag :options="c_menu_address" :value="scope.row.menuAddress"/>
        </template>
      </el-table-column>
      <el-table-column label="是否外链" align="center" prop="isFrame">
        <template #default="scope">
          <dict-tag :options="c_menu_is_frame" :value="scope.row.isFrame"/>
        </template>
      </el-table-column>
      <el-table-column label="是否缓存" align="center" prop="isChache">
        <template #default="scope">
